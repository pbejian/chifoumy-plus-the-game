...
def description(machine_gesture, user_gesture):
    ...
    """
    if user_gesture == machine_gesture:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Match nul !"
        return html_description
    elif user_gesture == 0 and machine_gesture == 2:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'>Gagné ! PIERRE écrase CISEAUX</div>"
        return html_description
    elif user_gesture == 0 and machine_gesture == 3:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Gagné ! PIERRE assomme PYTHON</div>"
        return html_description
    elif user_gesture == 0 and machine_gesture == 1:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Perdu ! FEUILLE recouvre PIERRE</div>"
        return html_description
    elif user_gesture == 0 and machine_gesture == 4:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Perdu ! SPOKE vaporise PIERRE</div>"
        return html_description
    elif user_gesture == 1 and machine_gesture == 0:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Gagné ! FEUILLE recouvre PIERRE</div>"
        return html_description
    elif user_gesture == 1 and machine_gesture == 4:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Gagné ! FEUILLE réfute SPOKE</div>"
        return html_description
    elif user_gesture == 1 and machine_gesture == 2:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Perdu ! CISEAUX découpent FEUILLE</div>"
        return html_description
    elif user_gesture == 1 and machine_gesture == 3:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Perdu ! PYTHON mange FEUILLE</div>"
        return html_description
    elif user_gesture == 2 and machine_gesture == 1:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Gagné ! CISEAUX découpent FEUILLE</div>"
        return html_description
    elif user_gesture == 2 and machine_gesture == 3:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Gagné ! CISEAUX décapitent PYTHON</div>"
        return html_description
    elif user_gesture == 2 and machine_gesture == 4:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Perdu ! SPOKE casse CISEAUX</div>"
        return html_description
    elif user_gesture == 2 and machine_gesture == 0:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Perdu ! PIERRE écrase CISEAUX</div>"
        return html_description
    elif user_gesture == 3 and machine_gesture == 1:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Gagné ! PYTHON mange FEUILLE</div>"
        return html_description
    elif user_gesture == 3 and machine_gesture == 4:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Gagné ! PYTHON empoisonne SPOKE</div>"
        return html_description
    elif user_gesture == 3 and machine_gesture == 2:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Perdu ! CISEAUX décapitent PYTHON</div>"
        return html_description
    elif user_gesture == 3 and machine_gesture == 0:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Perdu ! PIERRE assomme PYTHON</div>"
        return html_description
    elif user_gesture == 4 and machine_gesture == 0:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Gagné ! SPOKE vaporise PIERRE</div>"
        return html_description
    elif user_gesture == 4 and machine_gesture == 2:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Gagné ! SPOKE casse CISEAUX</div>"
        return html_description
    elif user_gesture == 4 and machine_gesture == 1:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Perdu ! FEUILLE réfute SPOKE</div>"
        return html_description
    elif user_gesture == 4 and machine_gesture == 3:
        html_description = "style='text-align:center;color:#44B7E3;font-size:30px'> Perdu ! PYTHON empoisonne SPOKE</div>"
        return html_description
...
if picture:
    ...
    if type(df) == type("toto"):
        ...
        if machine_score==MAX_SCORE:
            image_vainqueur = IMAGE_PIERRE_PATH + "machine.png"
            text_vainqueur = "Machine"
        elif user_score==MAX_SCORE:
            image_vainqueur = IMAGE_PIERRE_PATH + "human.png"
            text_vainqueur = "Humain"
        else:
            image_vainqueur = IMAGE_PIERRE_PATH + "unknown.png"
            text_vainqueur = ""
        ...
        <tr>
            ...
            <th style='text-align:center;font-size:30px'>🏆 Vainqueur</th>
        </tr>
        <tr>
            <td><img src='{image_user}' width='200'></td>
            <td><img src='{image_machine}' width='200'></td>
            <td><img src='{image_vainqueur}' width='200'></td>
        </tr>
        <tr>
            ...
            <td style='text-align:center;font-size:50px;color:#44B7E3'>{text_vainqueur}</td>
        </tr>
        <tr>
            <td colspan='3' {html_description} </td>
        </tr>
        </table>
        </div>
        <br>
        ...
        #-------------------------------------------------------------------
        if machine_score==MAX_SCORE:
            final_html = f"<blink><div style='text-align:center;color:#FF036A;font-size:30px'>➡️ Victoire de la machine ! ⬅️</div></blink>"
            # st.markdown(final_html, unsafe_allow_html=True)
            file = open("scores.txt", "w")
            file.write("0,0")
            file.close()
        if user_score==MAX_SCORE:
            final_html = f"<blink><div style='text-align:center;color:#FF036A;font-size:30px'>➡️ Victoire de l'humain ! ⬅️</div></blink>"
            # st.markdown(final_html, unsafe_allow_html=True)
            file = open("scores.txt", "w")
            file.write("0,0")
            file.close()
